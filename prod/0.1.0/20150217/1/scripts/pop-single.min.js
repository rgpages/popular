...
!function() {
    ...
    second = 1e3, minute = 6e4, hour = 36e5, day = 864e5, week = 6048e5, formats = {
        ...
        return twitterFormat = function(format) {
            ...
            num = 1; else if (minute > diff) unit = "seconds"; else if (hour > diff) unit = "minutes"; else if (day > diff) unit = "hours"; else {
            ...
            "long" === format && num > 1 && (unitStr += "s"), num + unitStr;
            ...
            if (!isSetup) {
                ...
                if (getStyle = function() {
                    ...
                    return function(elem) {
                        ...
                        return style || logError("Style returned " + style + ". Are you running this code in a hidden iframe on Firefox? See http://bit.ly/getsizeiframe"), 
                        style;
                    };
    ...
    "function" == typeof define && define.amd ? define("isotope/js/item", [ "outlayer/outlayer" ], itemDefinition) : "object" == typeof exports ? module.exports = itemDefinition(require("outlayer")) : (window.Isotope = window.Isotope || {}, 
    ...
    "function" == typeof define && define.amd ? define("isotope/js/layout-mode", [ "get-size/get-size", "outlayer/outlayer" ], layoutModeDefinition) : "object" == typeof exports ? module.exports = layoutModeDefinition(require("get-size"), require("outlayer")) : (window.Isotope = window.Isotope || {}, 
    ...
    "function" == typeof define && define.amd ? define("masonry/masonry", [ "outlayer/outlayer", "get-size/get-size" ], masonryDefinition) : "object" == typeof exports ? module.exports = masonryDefinition(require("outlayer"), require("get-size")) : window.Masonry = masonryDefinition(window.Outlayer, window.getSize);
}(window), function(window) {
    function extend(a, b) {
        for (var prop in b) a[prop] = b[prop];
        return a;
    ...
    "function" == typeof define && define.amd ? define("isotope/js/layout-modes/masonry", [ "../layout-mode", "masonry/masonry" ], masonryDefinition) : "object" == typeof exports ? module.exports = masonryDefinition(require("../layout-mode"), require("masonry-layout")) : masonryDefinition(window.Isotope.LayoutMode, window.Masonry);
}(window), function(window) {
    ...
    "function" == typeof define && define.amd ? define("isotope/js/layout-modes/fit-rows", [ "../layout-mode" ], fitRowsDefinition) : "object" == typeof exports ? module.exports = fitRowsDefinition(require("../layout-mode")) : fitRowsDefinition(window.Isotope.LayoutMode);
}(window), function(window) {
    ...
    "function" == typeof define && define.amd ? define("isotope/js/layout-modes/vertical", [ "../layout-mode" ], verticalDefinition) : "object" == typeof exports ? module.exports = verticalDefinition(require("../layout-mode")) : verticalDefinition(window.Isotope.LayoutMode);
}(window), function(window) {
    function extend(a, b) {
        for (var prop in b) a[prop] = b[prop];
        return a;
    ...
    function isotopeDefinition(Outlayer, getSize, matchesSelector, Item, LayoutMode) {
        ...
        Isotope.Item = Item, Isotope.LayoutMode = LayoutMode, Isotope.prototype._create = function() {
            ...
            var items;
            elems ? (elems = makeArray(elems), items = this.getItems(elems)) : items = this.items, 
    ...
    exports.register = function(moduleDeclaration) {
        registry.push(moduleDeclaration), initialized && moduleDeclaration.call(this);
    }, exports.init = function() {
        initialized = !0;
        for (var i = 0, l = registry.length; l > i; i++) registry[i].call(this);
    };
}(window.POP = window.POP || {}), POP.register(function() {
    "use strict";
    ...
    function debounce(fn, threshold) {
        ...
        return function() {
            ...
            timeout && clearTimeout(timeout), timeout = setTimeout(delayed, threshold || 100);
        };
    }
    $(function() {
        var qsRegex, API = "http://registerguard.com/csp/cms/sites/rg/feeds/popular.csp?callback=?&per=1", $isotope = $("#isotope").isotope({
            itemSelector: ".isotope_item",
            transitionDuration: ".5s",
            layoutMode: "fitRows",
            filter: function() {
                return qsRegex ? $(this).text().match(qsRegex) : !0;
            }
        }), _parse = function(json) {
            var html = "";
            return $.each(json.stories, function(i, item) {
                html += _render(item);
            }), html;
        }, _render = function(story) {
            return [ '<div class="isotope_item"' + (story.image ? ' style="background-image:url(' + story.server + story.image.path + ')"' : "") + ">", '<a href="' + story.server + story.path + '" target="_blank">', story.image ? '<img src="' + story.server + story.image.path + '">' : "", "<span>" + story.count + "</span>", story.published ? "<time>" + moment(story.published).twitterShort() + "</time>" : "", story.category ? "<h6>" + story.category + "</h6>" : "", '<h3 class="h1">' + story.headline + "</h3>", story.deck ? '<h4 class="sh4">' + story.deck + "</h4>" : "", story.byline ? "<p>By " + story.byline + "</p>" : "", "</a>", "</div>" ].join("\n");
        }, _infinite = function() {
            var $next = $("<a />", {
                id: "infscr-next"
            });
            $isotope.after($next).infinitescroll({
                path: function(index) {
                    return API + "&page=" + index;
                },
                navSelector: $next,
                nextSelector: $next,
                itemSelector: "#isotope .isotope_item",
                dataType: "json",
                appendCallback: !1,
                loading: {
                    msgText: "Wait",
                ...
                $isotope.infinitescroll("pause"), $newElements.imagesLoaded(function() {
            ...
            $.getJSON(API, {
                ...
                $newElements.imagesLoaded(function() {
                    var $aside = $('aside[role="complementary"]'), $search = $("<input />", {
                        type: "search",
                        placeholder: "Filter by keyword …"
                    }).appendTo($aside);
                    $isotope.isotope("once", "layoutComplete", function() {
                        $('footer[role="contentinfo"]').fadeIn("slow");
                    }), $loading.fadeOut("slow", function() {
                        $isotope.append($newElements).isotope("appended", $newElements), $search.keyup(debounce(function() {
                            qsRegex = new RegExp($search.val(), "gi"), $isotope.isotope();
                        }, 200)), $aside.fadeIn("slow"), _infinite();
                    });
                });
            });
        };
        $("<div />", {
            id: "isotope-loading"
        }).insertBefore($isotope).fadeIn("slow", _init);
    });
}), $(function() {
    "use strict";
    POP.init(), jQuery.noConflict();
});